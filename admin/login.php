	...
	if(isset($_POST['user']) && isset($_POST['pass'])) // si user et pass sont défini
	{
		...
		if($req->rowCount() == 1) // si le rowCount vaut 1 -> 1 signifie TRUE
		{
			...
			<body>
				<main>
					<div class="content">
						<p class="pLogo"><img src="../asset/img/logo-krav.png" alt="logo krav" class="logoAdmin"></p>

						<div class="formMain">
							<form action="#" method="post">
								<p><input type="text" name="user" placeholder="Identifiant" class="champAdmin"></p>
								<p><input type="password" name="pass" placeholder="mot de passe" class="champAdmin"></p>
								<?= $idsIncorrect; ?>
